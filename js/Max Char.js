...
// The first loop iterates through the given string. If the character does not already appear in the charMap object then it is added (ex: l:1). If the character is already in the charMap object then one is added to the object (ex: l:3. This continues until the loop iterates through the entire string then one is added to the count variable
